...
//  Baccus
//
//  Created by Antonio Martin on 17/09/13.
...
- (UIViewController *) rootViewControllerForPadWithModel: (AMEHWineryModel *) aModel{
    //Creamos los controladores
    AMEHWineryTableViewController *wineryVC = [[AMEHWineryTableViewController alloc] initWithModel:aModel
                                                                                             style:UITableViewStylePlain];
    
    AMEHWineViewController *wineVC = [[AMEHWineViewController alloc] initWithModel: [aModel redWineAtIndex:0]];
    ...
    //Creamos el combinador: SpliViewController
...
- (UIViewController *) rootViewControllerForPhoneWithModel: (AMEHWineryModel *) aModel{
    AMEHWineryTableViewController *wineryVC = [[AMEHWineryTableViewController alloc] initWithModel:aModel
                                                                                        style:UITableViewStylePlain];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //Creamos el model
    AMEHWineryModel *winery = [[AMEHWineryModel alloc] init];
    ...
    //Le asignamos un Controlador Raiz
